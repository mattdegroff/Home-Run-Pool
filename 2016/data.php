	<?php	
		...
		$deadline = new DateTime("2016-04-03 13:10:00");
		$groupDead = new DateTime("2016-04-03 13:10:00");
		$final = new DateTime("2016-10-02 23:59:59");
	?>						
					...
					<tr>
						<td>
							<table bgcolor=black align=center>
								<thead>
									<tr>
										<td colspan="4" id="dark">Groups<?php if (new DateTime() > $groupDead && new DateTime() < $deadline) { echo "<br>2016 Totals"; } if (new DateTime() > $deadline) { echo "<br>Final Totals"; } ?></td>
									</tr>
									<tr>
									...
									<tr>	
											<?php
												if (new DateTime() > $groupDead) {													
													...
													echo "<table bgcolor=#ffd700><thead><tr>";
													...
													echo "<table bgcolor=silver><thead><tr>";
													echo '<th width="225">Player</th><!--<th>Inning</th>--><th>HR</th>';
													...
													echo "<td bgcolor=#cd7f32>";
													echo "<table bgcolor=#cd7f32><thead><tr>";
													echo '<th width="225">Player</th><!--<th>Inning</th>--><th>HR</th>';
