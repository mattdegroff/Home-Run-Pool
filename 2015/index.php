<html>
	...
	<head>
		<title>HOME RUN DIRTY 2K15</title>
	...
	<div id="wrap">
		<div id="nav">
			<ul>				
				...
				<li><a href="/">2018</a></li>
				<li><a href="/2015/picks">Picks</a></li>
				<?php
					if (new DateTime() > $deadline) {
						'<li><a href="http://hrderby2k17.com/picks">Picks</a></li>';
					}
				?>					
		...
		<?php
			if (new DateTime() < $deadline) {
				echo '<h2><u>TEAMS LOCK APRIL 1, 2015 AT 1:10 PM</u></h2>';
			} else {
				echo '<h1 style="font-size: 45; margin-bottom: 0; padding-bottom: 0;">2015</h1>';
			}
		?>
