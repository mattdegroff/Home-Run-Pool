<?php
    ...
    if ($_SESSION['year'] == 2015){
		...
		$colorC = '#ffd966';
		$colorD = '#00b050';
		$deadline = new DateTime('2019-03-27T13:05:00', new DateTimeZone('America/New_York'));
		$groupDead = new DateTime('2019-02-21T12:00:00', new DateTimeZone('America/New_York'));
