	<?php	
		...
		$final = new DateTime("2017-10-01 23:59:59");
	?>						
	<style>
		.color {
			<?php
					...
					<tr>
						<td>
							<table bgcolor=black align=center>
								<thead>
									<tr>
										<td colspan="4" id="dark">Groups<?php if (new DateTime() > $groupDead && new DateTime() < $deadline) { echo "<br>2016 Totals"; } if (new DateTime() > $deadline && new DateTime() < $final) { echo "<br>Live Totals"; } if (new DateTime() > $final) { echo "<br>Final Totals"; }?></td>
									</tr>
									<tr>
